...
export const portfolioProjects = [
  {
    ...
    category: 'Game Art',
    shortDescription: 'Main slot game interface and symbol designs for an Egyptian-themed casino game.',
    ...
    role: 'Lead 2D Artist',
    description: 'Designed the complete UI, background, and high-paying symbols for a top-performing slot game. Focused on vibrant, gold-accented visuals to enhance player engagement and convey luxury.',
  },
  {
    id: '2',
    ...
    description: 'Created a highly detailed, multi-layered cyberpunk city background with parallax effects in mind. The goal was to create a dark, atmospheric sci-fi world with contrasting neon lights.',
  },
  {
    id: '3',
    ...
    description: 'Sculpted and painted the main dragon character used as the expanding wild symbol. Rendered cinematic sequences for big win animations.',
  },
  {
    id: '4',
    ...
    role: '2D Artist',
    description: 'A vibrant, colorful take on the classic Irish theme. Designed all symbols, background, and UI elements to be clear and appealing on mobile devices.',
  },
  {
    id: '5',
    title: 'Mystic Forest',
    ...
    description: 'Developed the visual style for a relaxing, magical forest-themed slot. Animated glowing plants and fireflies for the idle state.',
  },
  {
    id: '6',
    ...
    description: 'Designed three distinct Viking characters representing different bonus features. Focused on gritty, realistic textures and cinematic lighting.',
  }
];
...
export const blogPosts = [
  {
    ...
    category: 'Tutorials',
    date: 'Oct 15, 2026',
    excerpt: 'Learn the techniques I use to ensure that highly detailed symbols remain readable and impactful on small smartphone screens.',
  ...
  },
  {
    ...
    date: 'Oct 08, 2026',
    excerpt: 'A deep dive into the 3D workflow for creating the main character of Dragon\'s Horde, including sculpting, retopology, and rendering.',
  ...
  },
  {
    ...
    date: 'Oct 01, 2026',
    excerpt: 'Exploring the shift towards cinematic, narrative-driven experiences in the slot game industry and what it means for artists.',
